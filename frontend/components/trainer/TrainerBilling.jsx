                                ...
                                <tbody className="divide-y divide-slate-200 bg-white">
                                    {myBills.map((bill) => (
                                        <tr key={bill.id} className="hover:bg-slate-50 transition-colors">
                                            <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-slate-900 sm:pl-6">{bill.invoiceNumber}</td>
                                            <td className="whitespace-nowrap px-3 py-4 text-sm text-slate-500">{bill.date.toLocaleDateString()}</td>
                                            <td className="whitespace-nowrap px-3 py-4 text-sm text-slate-500">₹{bill.amount.toFixed(2)}</td>
